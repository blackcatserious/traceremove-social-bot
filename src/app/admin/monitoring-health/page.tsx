...
import { Activity, Server, Database, Zap, AlertTriangle, CheckCircle, Clock, TrendingUp, RefreshCw, Heart, Cpu, HardDrive } from 'lucide-react';
    ...
    <div className="main-content">
      <div className="fade-in">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-primary mb-2">System Monitoring & Health</h1>
            <p className="text-secondary">Real-time system metrics and service health monitoring</p>
          </div>
          <button
          ...
          <>
            ...
            <div className="grid-professional grid-cols-4 mb-8">
              ...
              <div className="card-professional">
                ...
                <div className="text-2xl font-bold text-primary mb-1">
                  {systemHealth.health.filter(h => h.status === 'healthy').length}
                </div>
                <div className="text-secondary text-sm">Healthy Services</div>
              </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div className="card-professional">
                <h2 className="text-xl font-bold text-primary mb-6">Service Health Status</h2>
